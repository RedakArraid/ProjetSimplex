...
#.......................................
#Fonction Simplexe
def simplexe0(matrice_initiale,save_ecrasement,matrices_intermediaires):
    ...
    matrices_intermediaires.append(matrice_suivante)
    #...................................
    #verification de la condition d'arret
    if max(matrice_suivante[0])>0:
    #...................................
        return simplexe0(matrice_suivante,save_ecrasement,matrices_intermediaires)
    else:
        return [matrice_suivante,save_ecrasement,matrices_intermediaires]
#.......................................
...
def solution(matrice_initiale):
    ...
    #...................................
        ...
        matrice_finale=[matrice_initiale,[],[matrice_initiale]]
    #...................................
    ...
    return (matrice_variables,matrice_solution,matrice_finale[2],solution_primal)
#...................................
...
def recdim(t):
    ...
    try:
        ...
        if (t[0].get()).lower()=="dk" :
            showinfo(title="présentation",message="Je suis le concepteur Diarrassouba Khadara"+"\n"+"pour vous servir.J'étais en 2 ième année ETE."+"\n"+"promo 13 année 2020-2021.")
        else:
            showwarning(message="entrez des valeurs correctes",title="Erreur de saisie")
def rec():
    global mat,be,mf
    res=[]
    ...
    aff=""
    #print(tab[2])
    for m in range(len(tab[2])):
        for i in range(len(tab[2][m])):
            for k in range(len(tab[2][m][i])):
                aff+=str(joli(tab[2][m][i][k]))+"  "
            aff+="\n"
